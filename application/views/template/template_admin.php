...
<html>
  <head>
	...
	<meta name="description" content="Aplikasi Ujian Online CBT">
	<meta name="keywords" content="Aplikasi Ujian Online CBT">
	<meta name="author" content="SMA ISLAM RF">
    <!-- Bootstrap 3.3.4 -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-lg"><b>Apk CBT SMA ISLAM RF</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url(); ?>public/plugins/adminlte/img/avatar1.jpg" class="user-image" alt="User Image"/>
                  <span class="hidden-xs"><?php if(!empty($nama)){ echo $nama; }else{ echo 'Administrator'; } ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<?php echo base_url(); ?>public/plugins/adminlte/img/avatar1.jpg" class="img-circle" alt="User Image" />
                    <p>
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Version: 2024.12.17</b>
        </div>
        <strong>&copy; 2024 Muhammad A'im STMIK-AKI PATI</strong>
      </footer>
