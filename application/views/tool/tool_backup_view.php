		...
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Klik tombol <b>Backup Database</b> untuk melakukan Backup database CBT A. Simpan backup database pada tempat yang aman.</p>
        ...
        <div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Restore Data Upload dilakukan dengan meng-copy data ke folder uploads pada folder utama CBT A</p>
                    </div>
		...
		<div class="col-md-6">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <p>Setelah CBT A digunakan dalam waktu yang lama dan menjalan banyak TES, maka session harus dibersikan.</p>
