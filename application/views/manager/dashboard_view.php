...
<section class="content">
    <div class="box box-default collapsed-box">
        ...
        <div class="box-body">
            Teruntuk sekolah saya SMA ISLAM RAUDLATUL FALAH yang saya cintai, Muhammad A'im. Pati 17 Desember 2024.
        </div><!-- /.box-body -->
    </div><!-- /.box -->
    <div class="box box-primary collapsed-box">
        ...
        <div class="box-body">
            <dl>
                <dd>
                    Dengan menggunakan Aplikasi CBT A, maka anda setuju untuk :
                    <ol>
                        <li>Tidak mengubah Nama Aplikasi Ujian Online <b> CBT A</b> menjadi nama aplikasi lain</li>
                        <li>Tidak mengubah footer yang menunjukkan alamat website Aplikasi Ujian Online CBT A</li>
                        <li>Tidak menjual Aplikasi Ujian Online CBT A</li>
                        <li>Tidak mengubah isi codingan Aplikasi Ujian Online CBT A</li>
                        <li>Tidak menhapus tribute dan Perjanjian Penggunaan</li>
                    </ol>
                    Semoga Aplikasi Ujian Online CBT A dapat bermanfaat untuk kita semua.
                </dd>
            </dl>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif CBT A, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian online.</p>
    </div>
